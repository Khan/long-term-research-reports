...
const Report = () =>
  <div className={css(styles.container)}>
    ...
    <p className={css(styles.lede)}>
      ...
      kindergarten range. We noticed an opportunity to investigate what it would
      mean to <em>empower children through mathematical concepts</em>—give them
      a space where they can create, explore, and mold their world by playing
      with the mathematical properties of the elements within it.
    </p>
    <Hairline />
    ...
    <p className={css(styles.body, styles.wideParagraph)}>
      We began the project by spending many weeks talking to experts, surveying
      the product landscape, reading associated research, and interviewing
      students, parents, and teachers. Insights from that background research
      informed our design principles, which we’ll explain shortly—but they’ll
      make more sense after we give you a taste of the sketches they inspired.
    </p>
    <PrototypeExample heading="Singing through touch">
      <Body>
        Our very first idea explored: what are all the ways a child might input
        a number? If you ask a kid their age, they often hold up their fingers –
        sometimes before they start saying the number. We prototyped ways we
        might take advantage of multi-touch input to connect multiple fingers on
        the screen to a display of symbolic quantity.
      </Body>
      <Body>
    ...
    <PrototypeExample heading="Altering the world using handwritten numbers">
      <Body>
        ...
        observations that many kids don’t yet feel in control of their situation
        and are often told what to do – made us feel that giving them control of
        a little digital world is a welcome break from the norm. In this sketch,
        we wondered if we could translate the students’ number expression
        abilities into something personally meaningful: the ability to precisely
        modify their world with numbers.
      </Body>
    ...
    <PrototypeExample heading="Subtraction blocks">
      ...
      <Body>
        Digital objects can disappear into thin air. We thought that might make
        for an interesting new angle on subtraction. Here the student can build
        a staircase down to the mysterious character below using negative “ghost
        blocks.”
      </Body>
    </PrototypeExample>
    <PrototypeExample heading="Place-value cards">
      <Body>
        ...
        manipulated individually or stacked on top of each other to represent a
        single two-digit number. The cards’ interactions implicitly illustrate
        decomposition in the base-ten number system—that 27 is the same as 20 +
        7.
      </Body>
      <Body>
        Unlike a physical version of these cards, kids can adjust the quantities
        in place, seeing their impact on another representation, like these
        birds.
      </Body>
    </PrototypeExample>
    ...
    <BodyAndSidebar>
      <Body>
        ...
        ourselves when designing solutions in this space. They continue to drive
        our research today.
      </Body>
      ...
      <Body>
        ...
        entangled with it. Interacting more deeply with your surroundings means
        interacting more deeply with the language and culture.
      </Body>
      <SidebarItem top={300}>
      ...
      <Body>
        ...
        constantly motivated by rich interactions inextricable from daily life.
      </Body>
      <Body>
        Can we build an environment whose objects and interactions are entangled
        with mathematical concepts in the same way—and where motivation comes
        from within?
      </Body>
      <Body>
        ...
        at manipulating mathematics. We believe the world doesn't need a trophy
        system: the desire to explore, interact, and create is motivation
        enough.
      </Body>
      <Body>
        <Principle>Creativity.</Principle> With creative freedom and exploration
        comes a wider variety of learning paths. One child might construct a
        mathematical concept through a generative painting; another might form
        the same idea making digital music. To learn, we connect new ideas to
        preexisting ones. A prescribed learning path allows no agency or
        creativity for the learner, their only option is compliance. But if
        children have agency in the mathematical activity, they'll find learning
        paths from their own entry points. We can still prescribe experiences in
      ...
      <Body>
        ...
        uncovering that learning path themselves, it’s more likely that they’ll
        understand why the entangled mathematical ideas behave as they do—not
        just how to perform an algorithm. With procedural understanding, we’re
        stuck as soon as we fall off a path we recognize. With conceptual
        understanding, we can correct our own errors and combine ideas in
        creative ways. That creativity leads to yet more learning paths and yet
        more understanding: the cycle continues.
      </Body>
    </BodyAndSidebar>
    <BodyAndSidebar>
      ...
      <Body>
        ...
        emotions, focusing on intellectual activities. But by creating the space
        for emotional connections to form, we pave the way for a deep, enduring
      ...
      <Body>
        ...
        child, forming an emotional bond that can inspire their involvement
        without outside coercion.
      </Body>
      <Body>
        <Principle>Curiosity.</Principle> Our art direction’s all about setting
        the stage for curiosity. For instance, in the scenario above, we’ve
        deliberately added lots of depth and occlusion. The child’s entering a
        whole new world, but we’re leaving space for their imagination, a
        feeling of possibility and a sense of adventure. The imagination,
        combined with the environment, evokes much more than we could have
        rendered ourselves.
      </Body>
      <Body>
        ...
        children create and discover in this world, we can empower them to share
        their inventions and experiences with loved ones. Creative mathematical
    ...
    <BodyAndSidebar>
      ...
      <Body>
        ...
        which reflect that power—which we’re genuinely and personally excited to
        share—rather than condescending tasks we pretend are interesting so that
        kids will learn “what's good for them”?
      </Body>
      <Body>
        <Principle>Empowerment.</Principle> In this project, we focused on
        empowerment and trusted that learning would follow. We explored creative
        tools for art and music, translating numeracy into interesting,
        personally-relevant creations. We imagined a world full of secrets worth
        exploring and empowered that exploration through mathematical
        understanding.
      </Body>
      <Body>
        <Principle>Growth.</Principle> Powerful ideas grow with people, and we
        wanted our design to do the same. Toddlers build simple structures with
        Duplo, then more complex objects with Lego, then moving parts with
        Technic, and even robotics with Mindstorms.
      </Body>
      <Body>
      ...
      <Body noBottomMargin>
        ...
        everything in their environment to a deeper mathematical representation.
        As students understand more math, they can redefine more of their world.
      </Body>
    </BodyAndSidebar>
    <Hairline />
    ...
    <StoryboardElement storyboardElementNumber={1}>
      <Body>
        We start in a scene that deliberately evokes depth and leaves space for
        the child’s imagination to participate. What’s hiding among the trees?
        Does the character live inside a tree?
      </Body>
      <Body>
        A coordinate indicator trails the character. If the child explores walks
        left from the red-door-tree, they’ll discover negative x-coordinates.
      </Body>
    </StoryboardElement>
    ...
    <StoryboardElement storyboardElementNumber={4}>
      <Body>
        ...
        befriend a little basket with its own coordinates. The basket will help
        the character by being the holding place for things that the character
        can collect: “quantity-bricks”, operators, and tools. These are
        mathematical properties with which to build or mold the world.
      </Body>
    </StoryboardElement>
    ...
    <StoryboardElement storyboardElementNumber={5}>
      <Body>
        ...
        tapping three flowers on a single stem allows our character to fill and
        collect a “3” quantity-brick. Each flower blooms when tapped, a gentle
        feedback that provides scaffolding towards{" "}
    ...
    <StoryboardElement storyboardElementNumber={6}>
      <Body>
        ...
        quantity-bricks. To sort the bricks by length, they compared quantities.
      </Body>
      <Body>
        Now our character can reach the yellow door. What's inside the tree?
      </Body>
      <Body>
        There were many solutions the student could have used to reach the door.
        Can you, the reader, think of others?
      </Body>
    </StoryboardElement>
    ...
    <StoryboardElement storyboardElementNumber={7}>
      <Body>
        ...
        tree, children can play with the relationship between numbers and sound;
        pitches correspond to quantities.
      </Body>
      <Body>
        <em>
    ...
    <StoryboardElement storyboardElementNumber={8}>
      ...
      <Body>
        At any time, learners can choose to “look behind” an activity to see its
        underlying mechanics. This could take the form of source code.
      </Body>
    </StoryboardElement>
    ...
    <StoryboardElement storyboardElementNumber={9}>
      <Body>
        ...
        happens upon a ladder, they can manipulate its height attribute, or its
        number of rungs.
      </Body>
    </StoryboardElement>
    ...
    <StoryboardElement storyboardElementNumber={10}>
      <Body>
        ...
        there but setting the ladder’s height to a huge number. They wouldn’t be
        able to collect a quantity large enough by counting, which would inspire
        the need for repetition or scaling, bases for the concepts of
    ...
    <Body wide>
      ...
      we’re just barely getting started on this journey. We believe educational
      technology has the potential to be so much more empowering than it is
      today. We reject a future in which children robotically compute answers to
      arithmetic worksheets. We dream of a future filled with curious explorers
      and lifelong learners, solving important human problems. We’ll continue to
      experiment in this space as part of our long-term research, but we hope
      that these sketches and design principles inspire others to join us in
      pushing toward a humane future of learning technology.
    </Body>

    <Heading>Acknowledgements</Heading>
    <Body wide>
      This report was written by May-Li Khoe, Andy Matuschak, and Scott Farrar,
      documenting research primarily conducted in 2015 by May-Li Khoe, Andy
      Matuschak, and Jason Brennan. Illustrations by May-Li Khoe and Natalie
      Fitzgerald.
    </Body>
    <Body wide>
      We'd like to thank these people for their valuable thoughts along the way:{" "}
      {[
        "Bret Victor",
        "Chaim Gingold",
        "Sonia Cho",
    ...
    <Body wide>
      If you're interested in reading more about the topics in this report, our
    ...
    <ul className={css(styles.furtherReadingList)}>
      ...
      <FurtherReadingItem>
        Holt, John. 1964. <em>How children fail</em>. Pitman Publishing Company.
      </FurtherReadingItem>
      <FurtherReadingItem>
